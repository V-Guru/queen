...
import kotlinx.android.synthetic.main.activity_using_wozart_faq.*
 ...
 *
 *****************************************************************************/
class UsingWozartFaq : AppCompatActivity(){

    var card_openCheck = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_using_wozart_faq)
