package com.wozart.aura.ui.customview.spotlight.target;
...
import com.wozart.aura.ui.customview.spotlight.OnTargetStateChangedListener;
import com.wozart.aura.ui.customview.spotlight.shape.Shape;
...
public class SimpleTarget extends Target {
  ...
  public static class Builder extends AbstractTargetBuilder<Builder, SimpleTarget> {
    ...
    public SimpleTarget build() {
      ...
      View overlay = getContext().getLayoutInflater().inflate(R.layout.layout_spot_light, root,false);
      TextView titleView = overlay.findViewById(R.id.title);
      TextView descriptionView = overlay.findViewById(R.id.description);
      RelativeLayout layout = overlay.findViewById(R.id.container);
      if (title != null) {
